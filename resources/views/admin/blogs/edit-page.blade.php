                  ...
                  <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <select id="type" name="type" value="index,nofollow" class="form-select">
                            <option {{ $rowData->type == 'Blog'?'selected':'' }} value="Blog">Blog</option>
                            <option {{ $rowData->type == 'Event'?'selected':'' }} value="Event">Event</option>
                        </select>
                      </div>
                    </div>
                   <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" placeholder="Enter Tags" name="tags" id="tags">{!! $rowData->tags !!}</textarea>
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                    ...
                    <div class="col-md-2">
                      <div class="form-group">
                        ...
                        <img src="{{URL::asset('public/img/blogs/')}}/{!! $rowData->image !!}"  style="max-width:150px;height: auto;"> </div>
                    </div>  
                    @endif     
                    </div>                     
                </div>
