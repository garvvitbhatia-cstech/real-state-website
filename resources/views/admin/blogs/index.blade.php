                ...
                <div class="card-body">
                    ...
                    <form id="searchForm" name="searchForm" class="float-start">
                        <div class="d-flex align-items-center  w-md-800px">
                            ...
                            <div class="position-relative w-md-200px me-md-2">
                                <input id="tags" name="tags" confirmation="false" class="form-control" placeholder="Search By Tags">
                            </div>
                            <!--end::Input group-->
                            <!--begin:Action-->
                    ...
                    <a href="{{url('/admin/add-blog')}}" class="btn icon btn-sm btn-outline-success float-end">Add Blog</a>
                </div>
                <!--end::Card body-->
            </div>
        </section>
