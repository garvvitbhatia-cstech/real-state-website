              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Sub Heading" value="" name="sub_heading" id="sub_heading">
                  </div>
                </div>                 
                <div class="col-md-4">
                  <div class="form-group">
...
<script type="text/javascript"> 
    ...
    let saveDataURL = "{{url('/admin/add-award/')}}";
    let returnURL = "{{url('/admin/awards')}}";
</script> 
<script src="{{ asset('public/admin/js/pages/awards/add-page.js') }}"></script> 
@endsection