        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">Our Brand list.</p>
                </div>
            ...
            <div class="card">
               <!--begin::Card body-->
                <div class="card-body">
                    ...
                    <form id="searchForm" name="searchForm" class="float-start">
                        <div class="d-flex align-items-center  w-md-800px">
                            ...
                            <div class="position-relative w-md-200px me-md-2">
                                <input id="status" name="status" confirmation="false" class="form-control" placeholder="Search By Heading">
                            </div>
                            <!--end::Input group-->
                            <!--begin:Action-->
                    ...
                    <a href="{{url('/admin/add-award')}}" class="btn icon btn-sm btn-outline-success float-end">Add New Brand</a>
                </div>
                <!--end::Card body-->
            </div>
        </section>
