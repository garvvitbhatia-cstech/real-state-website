      ...
      <div class="col-12 col-md-6 order-md-2 order-first">
        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Edit Our Opening</li>
          </ol>
        </nav>
      </div>
    </div>
        	...
        	<div class="card-body">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Category" value="{!! $rowData->category !!}" name="category" id="category">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                ...
                <div class="col-md-2">
                  <div class="form-group">
                    ...
                    <img src="{{URL::asset('public/img/categories/')}}/{!! $rowData->banner !!}"  style="max-width:150px;height: auto;"> </div>
                </div>
                @endif                  
                </div>                    
...
<script type="text/javascript"> 
    ...
    let saveDataURL = "{{url('/admin/edit-our-opening/'.$row_id)}}";
    let returnURL = "{{url('/admin/our-opening')}}";
</script> 
<script src="{{ asset('public/admin/js/pages/ouropening/edit-page.js') }}"></script> 
@endsection