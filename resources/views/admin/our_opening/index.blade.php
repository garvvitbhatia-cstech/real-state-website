                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Our Openning</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="card">
               <!--begin::Card body-->
                <div class="card-body">
                    ...
                    <form id="searchForm" name="searchForm" class="float-start">
                        <div class="d-flex align-items-center  w-md-800px">
                            ...
                            <div class="position-relative w-md-200px me-md-2">
                                <input id="category" name="category" confirmation="false" class="form-control" placeholder="Search By Category">
                            </div>
                            <!--end::Input group-->
                            <!--begin:Action-->
                    ...
                    <a href="{{url('/admin/add-our-opening')}}" class="btn icon btn-sm btn-outline-success float-end">Add New Opening</a>
                </div>
                <!--end::Card body-->
            </div>
        </section>
...
function filterData(type = null){
	...
	$.ajax({
		...
		url: "{{ url('/admin/ouropening_paginate') }}",
