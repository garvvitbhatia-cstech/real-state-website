        	...
        	<div class="card-body">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="basicInput">Page</label>
                    <select class="form-control" placeholder="Enter Page" value="" name="page" id="page">
                    	<option {{$rowData->page == 'Home'?'selected':''}} value="Home">Home</option>
                        <option {{$rowData->page == 'About Us'?'selected':''}} value="About Us">About Us</option>
                        <option {{$rowData->page == 'Our Team'?'selected':''}} value="Our Team">Our Team</option>
                    </select>
                  </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Text" value="{!! $rowData->text !!}" name="text" id="text">
                  </div>
                </div>                                    
                <div class="col-md-4">
                  <div class="form-group">
                ...
                <div class="col-md-2">
                  <div class="form-group">
                    ...
                    <img src="{{URL::asset('public/img/blogs/')}}/{!! $rowData->banner !!}" style="max-width:100px;height:auto;"> 
                  </div>
                </div>
                @endif                              
                </div>                    
