      ...
      <div class="col-12 col-md-6 order-md-2 order-first">
        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Add Toll Free</li>
          </ol>
        </nav>
      </div>
    </div>
                       ...
                       <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <input type="text" class="numberonly form-control" maxlength="15" name="contact" id="contact" placeholder="Contact">
                          </div>
                        </div>  
                        <div class="col-md-2">
                          <div class="form-group">
                            <label for="basicInput">From</label>
                            <input type="time" class="form-control" name="from" id="from" accept="image/*">
                          </div>
                        </div> 
                        <div class="col-md-2">
                          <div class="form-group">
                            <label for="basicInput">To</label>
                            <input type="time" class="form-control" name="to" id="to" accept="image/*">
                          </div>
                        </div>  
                        <div class="col-md-12">
                          <div class="form-group">
...
<script type="text/javascript">
    ...
    let saveDataURL = "{{url('/admin/add-toll-free')}}";
    let returnURL = "{{url('/admin/toll-free')}}";
</script> 
<script src="{{ asset('public/admin/js/pages/toll_free/add-page.js') }}"></script> 
@endsection