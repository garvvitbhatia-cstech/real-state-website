    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Toll Free Management</h3>
                <p class="text-subtitle text-muted">Toll Free list.</p>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{url('/admin')}}">Dashboard</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Toll Free</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="card">
           <!--begin::Card body-->
            <div class="card-body">
                ...
                <form id="searchForm" name="searchForm" class="float-start">
                    <div class="d-flex align-items-center  w-md-800px">
                        ...
                        <div class="position-relative w-md-200px me-md-2">
                            <select name="city" id="city" class="form-select" placeholder="Search By city">
                ...
                <!--<a href="{{url('/admin/add-toll-free')}}" class="btn icon btn-sm btn-outline-success float-end">Add Toll Free</a>-->
            </div>
            <!--end::Card body-->
        </div>
    </section>
...
function filterData(type = null){
	...
	$.ajax({
		...
		url: "{{ url('/admin/toll_free_paginate') }}",
