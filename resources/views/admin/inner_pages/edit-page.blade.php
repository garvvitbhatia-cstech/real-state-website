                  ...
                  <div class="row">
                    ...
                    <div class="col-md-2">
                      <div class="form-group">
                        ...
                        <img src="{{URL::asset('public/img/banners/')}}/{!! $rowData->banner !!}"  style="max-width:150px;height: auto;"> </div>
                    </div>
                    @endif 
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" name="banner_status" value="1" {{ $rowData->banner_status == 1?'checked':'' }} id="banner_status">
